const contractAddress = "0xeb69aB4E00B1Ce98E17f6e7DD2FaB91abEB4eccA"; // Replace with your own contract address
const chain = 'rinkeby'; // rinkeby, polygon, or ethereum

const welcome_h1 = "Welcome to the Tiffany Tatum NFT Project!!";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'The Tiffany Tatum NFT Project is the 1st. NFT collection from this artist. Follow her here <a href="https://tiffanynft.com/"  target="_blank" rel="noopener noreferrer">Tiffanys</a> YouTube channel.';
